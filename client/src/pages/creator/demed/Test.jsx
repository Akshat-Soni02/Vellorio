...
import { login_creator,setLoading,resetLoading } from '../../../store/UserSlice.js';
...
const Test = () => {
    ...
    const handleSelectChange = (languages) => {
        setFormData({ ...formData, languages: languages.map(option => option.value) });
    };
            ...
            <section className="proInfo">
                <section className="left_proInfo">
                    ...
                    <div className="save_creator">
                        <button className="save_creator_bttn" onClick={handleSubmit}>Save</button>
                    </div>
                </section>
                        ...
                        <form className="infoFill_form" onSubmit={handleSubmit}>
                            {selectedSection === "des" && (
                                <div className="cpField">
                                    ...
                                    <textarea className='cpInput desInput' rows={4} cols={5} name='description' id='description'required placeholder="Share a bit about your work experience, cool projects you've completed etc."
                                ...
                                <div className="cpField">
                                    <div className="lanInput">
                                        <Select
                                            ...
                                            value={colourOptions.filter(option => formData.languages.includes(option.value))} // Setting the selected options
                            ...
                            {selectedSection === "edu" && (
                                <div className="cpField">
                                    ...
                                    <textarea className='cpInput desInput' rows={4} cols={5} name='education' id='education' required placeholder="Your highest level of education or related to work"
                                ...
                                <div className='ski_div'>
                                    <div className="cpField">
                                        <Select
                                            ...
                                            isMulti
                                            required
                                            value={groupedOptions.flatMap(group => group.options.filter(option => formData.skills.includes(option.value)))} // Setting the selected options
