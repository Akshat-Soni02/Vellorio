      ...
      return (
        <div className="flex align-items-center selectedL">
          <img
            ...
            className={`mr-2 flag flag-${option.code.toLowerCase()} searchCustom`}
            style={{ width: "18px" }}
          />
          <div>{option.name}</div>
        </div>
    ...
    return (
      <div className="flex align-items-center opTemp">
        <img
          alt={option.name}
          src="https://primefaces.org/cdn/primereact/images/flag/flag_placeholder.png"
          className={`mr-2 flag flag-${option.code.toLowerCase()} serachIco`}
          style={{ width: "18px" }}
        />
        <div>{option.name}</div>
      </div>
    ...
    <>
      <section className="proInfo">
        ...
        <section className="cpDescribe">
          ...
          <p className="cp-des-p">
            This is your time to shine. Let potential buyers know what you do
            best and how you gained you skills and experience.
          </p>
        </section>
            ...
            <div className="cpField">
              ...
              <div className="card flex justify-content-center">
                <Dropdown
                  ...
                  className="w-full md:w-14rem cpInput lInput"
                />
              </div>
